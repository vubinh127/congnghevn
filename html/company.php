    ...
    <main class="company_page">
        <div class="main-content">
            <div class="hero-section">
                <div class="hero-text">
                    <h1>Cloud Computing:<br>
                    The Digital Transformation Enabler</h1>
                    <p>VNG Cloud offers cutting-edge cloud computing infrastructure, ensuring high stability and quick adaptation to digital transformation need
                    </p>
                    ...
                    <div class="about_detail order-2 order-xl-1">
                        ...
                        <div class="number_data">
                            ...
                            <div>
                                ...
                                <div class="text">Chứng chỉ quốc tế</div>
                            </div>
                            <div>
                                <div class="number">50+</div>
                                <div class="text">Hệ sinh thái dịch vụ</div>
                            </div>
                        </div>
                    </div>
